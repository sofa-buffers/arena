...
LANGS="${LANGS:-c-embedded cpp rust zig dart go csharp java kotlin-mp typescript typescript-bun python rust-embedded cpp-embedded c-cortex-m cpp-cortex-m rust-cortex-m c-riscv cpp-riscv rust-riscv}"
DO_SETUP=1
