...
impl<'a> Visitor for V<'a> {
    fn unsigned(&mut self, id: Id, value: Unsigned) {
        ...
        match (self.cur, id) {
            ...
            (_Loc::Root_arrays, 0) => { if self.afill == 0 { return; } self.afill -= 1; if value > 255 { self.inv = true; return; } self.m.arrays.u8.push(value as u8); },
            (_Loc::Root_arrays, 2) => { if self.afill == 0 { return; } self.afill -= 1; if value > 65535 { self.inv = true; return; } self.m.arrays.u16.push(value as u16); },
            (_Loc::Root_arrays, 4) => { if self.afill == 0 { return; } self.afill -= 1; if value > 4294967295 { self.inv = true; return; } self.m.arrays.u32.push(value as u32); },
    ...
    fn signed(&mut self, id: Id, value: Signed) {
        ...
        match (self.cur, id) {
            ...
            (_Loc::Root_arrays, 1) => { if self.afill == 0 { return; } self.afill -= 1; if value < -128 || value > 127 { self.inv = true; return; } self.m.arrays.i8.push(value as i8); },
            (_Loc::Root_arrays, 3) => { if self.afill == 0 { return; } self.afill -= 1; if value < -32768 || value > 32767 { self.inv = true; return; } self.m.arrays.i16.push(value as i16); },
            (_Loc::Root_arrays, 5) => { if self.afill == 0 { return; } self.afill -= 1; if value < -2147483648 || value > 2147483647 { self.inv = true; return; } self.m.arrays.i32.push(value as i32); },
