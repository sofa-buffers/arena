...
impl<'a> Visitor for V<'a> {
    fn unsigned(&mut self, id: Id, value: Unsigned) {
        match (self.cur, id) {
            ...
            (_Loc::Root_arrays, 2) => self.m.arrays.u16.push(value as u16),
            (_Loc::Root_arrays, 4) => self.m.arrays.u32.push(value as u32),
            (_Loc::Root_arrays, 6) => self.m.arrays.u64.push(value as u64),
            _ => {}
        }
    }
    fn signed(&mut self, id: Id, value: Signed) {
        match (self.cur, id) {
            ...
            (_Loc::Root_arrays, 1) => self.m.arrays.i8.push(value as i8),
            (_Loc::Root_arrays, 3) => self.m.arrays.i16.push(value as i16),
            (_Loc::Root_arrays, 5) => self.m.arrays.i32.push(value as i32),
            (_Loc::Root_arrays, 7) => self.m.arrays.i64.push(value as i64),
            _ => {}
        }
    }
    fn fp32(&mut self, id: Id, value: f32) {
        match (self.cur, id) {
            ...
            (_Loc::Root_arrays_nested, 0) => self.m.arrays.nested.fp32.push(value),
            _ => {}
        }
    }
    fn fp64(&mut self, id: Id, value: f64) {
        match (self.cur, id) {
            ...
            (_Loc::Root_arrays_nested, 1) => self.m.arrays.nested.fp64.push(value),
            _ => {}
        }
    }
    ...
    fn array_begin(&mut self, id: Id, _kind: ArrayKind, _count: usize) {
        match (self.cur, id) {
            (_Loc::Root_arrays, 0) => self.m.arrays.u8.clear(),
            (_Loc::Root_arrays, 1) => self.m.arrays.i8.clear(),
            (_Loc::Root_arrays, 2) => self.m.arrays.u16.clear(),
            (_Loc::Root_arrays, 3) => self.m.arrays.i16.clear(),
            (_Loc::Root_arrays, 4) => self.m.arrays.u32.clear(),
            (_Loc::Root_arrays, 5) => self.m.arrays.i32.clear(),
            (_Loc::Root_arrays, 6) => self.m.arrays.u64.clear(),
            (_Loc::Root_arrays, 7) => self.m.arrays.i64.clear(),
            (_Loc::Root_arrays_nested, 0) => self.m.arrays.nested.fp32.clear(),
            (_Loc::Root_arrays_nested, 1) => self.m.arrays.nested.fp64.clear(),
            _ => {}
        }
    }
