  ...
  TypedData? onArrayDest(int id, sofab.ArrayKind kind, int count) {
    switch (id) {
      case 0:
        ...
        return null;
      case 1:
        if (kind == sofab.ArrayKind.signed) return super.onArrayDest(id, kind, count);
        return null;
      case 2:
        if (kind == sofab.ArrayKind.unsigned) return super.onArrayDest(id, kind, count);
        return null;
...
class _ExampleArraysNestedVisitor extends sofab.VisitorBase {
  ...
  TypedData? onArrayDest(int id, sofab.ArrayKind kind, int count) {
    switch (id) {
      case 0:
        if (kind == sofab.ArrayKind.fp32) return super.onArrayDest(id, kind, count);
        return null;
      case 1:
        if (kind == sofab.ArrayKind.fp64) return super.onArrayDest(id, kind, count);
        return null;
    }
    return null;
  }
  ...
  Uint8List? onBytesDest(int id, int subtype, int total) {
    switch (id) {
      case 2:
        ...
        return null;
      case 3:
        if (subtype == sofab.FixlenType.blob) return super.onBytesDest(id, subtype, total);
        return null;
    }
    return null;
  }
