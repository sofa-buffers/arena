...
void fill(Example &m)
{
    ...
    // ctor/operator= (generator#37), natural brace-init sets the logical length
    // correctly — the earlier push_back workaround is no longer needed.
    m.string_array = {
        "Hello, Sofab!",
        "",
        "1234567890",
...
int main()
{
    ...
    const double mbs = (cpu > 0.0)
        ...
        : 0.0;
    printf("BENCH lang=cpp-embedded impl=sofab serialized_bytes=%zu iters=%ld "
