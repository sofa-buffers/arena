...
@file:Suppress("RedundantVisibilityModifier", "unused", "RemoveRedundantCallsOfConversionMethods", "KotlinConstantConditions")
...
internal class ExampleVisitor(private val m: Example) : Visitor {
    ...
    override fun string(id: Int, total: Int, offset: Int, data: ByteArray, chunkOffset: Int, chunkLength: Int) {
        ...
        when (cur) {
            ...
            4 -> Seq.placeElem(m.string_array, id, "", s, 5, MAX_DYN_ARRAY_COUNT)
        }
    }
