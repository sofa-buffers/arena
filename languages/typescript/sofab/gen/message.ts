  ...
  static decodeInto(c: Cursor, o: ExampleArraysNested): ExampleArraysNested {
    while (c.readHeader()) {
      ...
      case 0: {
        ...
        if (_n > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "fp32: array count above schema capacity 5");
        const _dv = new DataView(_p.buffer, _p.byteOffset, _p.byteLength);
      ...
      case 1: { if (c.wire !== WireType.ArrayFixlen || c.fixSub !== FixlenSubtype.Fp64) { c.skip(c.wire); break; } const _a = c.readFp64Array(5); if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "fp64: array count above schema capacity 5"); o.fp64 = _a; break; }
      default: c.skip(c.wire); break;
      }
    }
    return o;
...
export class Example {
  ...
  static decodeInto(c: Cursor, o: Example): Example {
    while (c.readHeader()) {
      switch (c.id) {
      case 0: { if (c.wire !== WireType.Unsigned) { c.skip(c.wire); break; } const _v = Number(c.readUnsigned()); if (_v > 255) throw new SofabError(SofabErrorCode.InvalidMsg, "u8: value outside declared width u8"); o.u8 = _v; break; }
      case 1: { if (c.wire !== WireType.Signed) { c.skip(c.wire); break; } const _v = Number(c.readSigned()); if (_v < -128 || _v > 127) throw new SofabError(SofabErrorCode.InvalidMsg, "i8: value outside declared width i8"); o.i8 = _v; break; }
      case 2: { if (c.wire !== WireType.Unsigned) { c.skip(c.wire); break; } const _v = Number(c.readUnsigned()); if (_v > 65535) throw new SofabError(SofabErrorCode.InvalidMsg, "u16: value outside declared width u16"); o.u16 = _v; break; }
      case 3: { if (c.wire !== WireType.Signed) { c.skip(c.wire); break; } const _v = Number(c.readSigned()); if (_v < -32768 || _v > 32767) throw new SofabError(SofabErrorCode.InvalidMsg, "i16: value outside declared width i16"); o.i16 = _v; break; }
      case 4: { if (c.wire !== WireType.Unsigned) { c.skip(c.wire); break; } const _v = Number(c.readUnsigned()); if (_v > 4294967295) throw new SofabError(SofabErrorCode.InvalidMsg, "u32: value outside declared width u32"); o.u32 = _v; break; }
      case 5: { if (c.wire !== WireType.Signed) { c.skip(c.wire); break; } const _v = Number(c.readSigned()); if (_v < -2147483648 || _v > 2147483647) throw new SofabError(SofabErrorCode.InvalidMsg, "i32: value outside declared width i32"); o.i32 = _v; break; }
