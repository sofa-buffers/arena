...
export class ExampleArrays {
  ...
  static decodeFrom(c: Cursor): ExampleArrays {
    ...
    while (c.readHeader()) {
      switch (c.id) {
      case 0: { const _a = c.readUnsignedArray() as number[]; if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "u8: array count above schema capacity 5"); o.u8 = _a; break; }
      case 1: { const _a = c.readSignedArray() as number[]; if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "i8: array count above schema capacity 5"); o.i8 = _a; break; }
      case 2: { const _a = c.readUnsignedArray() as number[]; if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "u16: array count above schema capacity 5"); o.u16 = _a; break; }
      case 3: { const _a = c.readSignedArray() as number[]; if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "i16: array count above schema capacity 5"); o.i16 = _a; break; }
      case 4: { const _a = c.readUnsignedArray() as number[]; if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "u32: array count above schema capacity 5"); o.u32 = _a; break; }
      case 5: { const _a = c.readSignedArray() as number[]; if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "i32: array count above schema capacity 5"); o.i32 = _a; break; }
      case 6: { const _a = c.readUnsignedArrayLong(); if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "u64: array count above schema capacity 5"); o._u64 = _a; break; }
      case 7: { const _a = c.readSignedArrayLong(); if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "i64: array count above schema capacity 5"); o._i64 = _a; break; }
...
export class ExampleArraysNested {
  ...
  static decodeFrom(c: Cursor): ExampleArraysNested {
    ...
    while (c.readHeader()) {
      switch (c.id) {
      case 0: { const _a = c.readFp32Array(); if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "fp32: array count above schema capacity 5"); o.fp32 = _a; break; }
      case 1: { const _a = c.readFp64Array(); if (_a.length > 5) throw new SofabError(SofabErrorCode.InvalidMsg, "fp64: array count above schema capacity 5"); o.fp64 = _a; break; }
      default: c.skip(c.wire); break;
      }
    }
    return o;
