...
// Shared zero-length placeholders, one per typed-array type: an empty typed
// array holds nothing and cannot be written through, so a single instance
// serves every empty default, visitor register and target slot below.
const _E_Uint8Array = new Uint8Array(0);
const _E_Int8Array = new Int8Array(0);
const _E_Uint16Array = new Uint16Array(0);
const _E_Int16Array = new Int16Array(0);
const _E_Uint32Array = new Uint32Array(0);
const _E_Int32Array = new Int32Array(0);
...
export class ExampleArrays {
  ...
  /** Schema bound: count 5 is a CAPACITY, not a length -- starts empty; over 5 elements is INVALID, never truncated. */
  i8: Int8Array = _E_Int8Array;
  /** Schema bound: count 5 is a CAPACITY, not a length -- starts empty; over 5 elements is INVALID, never truncated. */
  u16: Uint16Array = _E_Uint16Array;
  /** Schema bound: count 5 is a CAPACITY, not a length -- starts empty; over 5 elements is INVALID, never truncated. */
  i16: Int16Array = _E_Int16Array;
  /** Schema bound: count 5 is a CAPACITY, not a length -- starts empty; over 5 elements is INVALID, never truncated. */
  u32: Uint32Array = _E_Uint32Array;
  /** Schema bound: count 5 is a CAPACITY, not a length -- starts empty; over 5 elements is INVALID, never truncated. */
  i32: Int32Array = _E_Int32Array;
  private _u64: Long[] = [];
  /** Schema bound: count 5 is a CAPACITY, not a length -- starts empty; over 5 elements is INVALID, never truncated. */
...
export class ExampleArraysNested {
  ...
  /** Schema bound: count 5 is a CAPACITY, not a length -- starts empty; over 5 elements is INVALID, never truncated. */
  fp64: Float64Array = _E_Float64Array;
...
class _ExampleArraysVis implements Visitor {
  ...
  private _a0U8: Uint8Array = _E_Uint8Array;
  private _a0I8: Int8Array = _E_Int8Array;
  private _a0U16: Uint16Array = _E_Uint16Array;
  private _a0I16: Int16Array = _E_Int16Array;
  private _a0U32: Uint32Array = _E_Uint32Array;
  private _a0I32: Int32Array = _E_Int32Array;
  private _a0U64: Long[] = [];
  private _a0I64: Long[] = [];
    ...
    switch (this._c) {
      ...
      case _L_ExampleArrays_nested: {
        ...
        case 0: {
          ...
          const _t = this._tf; _t.f32 = this._a1Fp32;
          return _t;
        }
        case 1: {
...
class _ExampleArraysNestedVis implements Visitor {
  ...
  arrayBulk(id: number, kind: ArrayKind, count: number): ArrayTarget | null {
    ...
    case 0: {
      if (kind !== ArrayKind.Fp32) break;
      const _t = this._tf; _t.f32 = this._a0Fp32;
      return _t;
    }
    case 1: {
      if (kind !== ArrayKind.Fp64) break;
...
class _ExampleVis implements Visitor {
  ...
  private readonly _tf: FloatArrayTarget = { f32: _E_Float32Array };
  private readonly _td: FloatArrayTarget = { f64: _E_Float64Array };
  private _a2U8: Uint8Array = _E_Uint8Array;
  private _a2I8: Int8Array = _E_Int8Array;
  private _a2U16: Uint16Array = _E_Uint16Array;
  private _a2I16: Int16Array = _E_Int16Array;
  private _a2U32: Uint32Array = _E_Uint32Array;
  private _a2I32: Int32Array = _E_Int32Array;
  private _a2U64: Long[] = [];
  private _a2I64: Long[] = [];
  private _a3Fp32: Float32Array = _E_Float32Array;
  private _a3Fp64: Float64Array = _E_Float64Array;
  ...
  arrayBulk(id: number, kind: ArrayKind, count: number): ArrayTarget | null {
    switch (this._c) {
      ...
      case _L_Example_arrays_nested: {
        ...
        case 0: {
          if (kind !== ArrayKind.Fp32) break;
          const _t = this._tf; _t.f32 = this._a3Fp32;
          return _t;
        }
        case 1: {
          if (kind !== ArrayKind.Fp64) break;
