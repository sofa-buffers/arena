...
import { OStream, Cursor, WireType, FixlenSubtype, Long, SofabError, SofabErrorCode, Visitor, IStream, DecodeStatus, ArrayKind, PayloadAcc, decodeUtf8, StringSeq } from "@sofa-buffers/corelib";
...
export class Example {
  ...
  static decodeInto(c: Cursor, o: Example): Example {
    while (c.readHeader()) {
      ...
      case 6: if (c.wire !== WireType.Unsigned) { c.skip(c.wire); break; } o._u64 = c.readUnsignedLong(); break;
      case 7: if (c.wire !== WireType.Signed) { c.skip(c.wire); break; } o._i64 = c.readSignedLong(); break;
...
class _ExampleNestedVis implements Visitor {
  ...
  string(id: number, total: number, offset: number, chunk: Uint8Array): void {
    switch (id) {
      case 2: { if (total > 32) throw new SofabError(SofabErrorCode.InvalidMsg, "str: string byte length above schema maxlen 32"); const _p = this.a.take(total, offset, chunk); if (_p === null) break; this.o.str = decodeUtf8(_p); break; }
      default: break;
    }
  }
...
class _ExampleVis implements Visitor {
  ...
  sequenceBegin(id: number): Visitor | null {
    switch (id) {
      ...
      case 200: this.o.string_array = []; return new StringSeq(this.o.string_array, this.a, 5, 64, "string_array");
      default: break;
    }
    return null;
  }
...
export class ExampleDecoder {
  ...
  private readonly acc = new PayloadAcc();
